...
│   │                 # security.allowed_source_roots allowlist that every plugin
│   │                 # reading a configured path resolves against
...
└── utils/            # Utility functions (list_merge, series, sorting, urls for the
                      # scheme and local-host guards)
