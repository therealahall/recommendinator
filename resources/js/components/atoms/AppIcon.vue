...
const GLYPHS = {
  ...
  chevron: { stroke: 2.4, d: ['m6 9 6 6 6-6'] },
  ...
  game: {
    stroke: 1.7,
    d: [
      'M6.5 7h11a4.5 4.5 0 0 1 0 9h-11a4.5 4.5 0 0 1 0-9z',
      'M7 9.5v3',
      'M5.5 11h3',
      'M17.4 11.5a.9.9 0 1 1-1.8 0 .9.9 0 0 1 1.8 0z',
      'M19.9 13.7a.9.9 0 1 1-1.8 0 .9.9 0 0 1 1.8 0z',
    ],
  },
  image: {
    stroke: 1.7,
    d: [
      'M5.5 4h13A2.5 2.5 0 0 1 21 6.5v11a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 3 17.5v-11A2.5 2.5 0 0 1 5.5 4z',
      'M10.1 9.5a1.6 1.6 0 1 1-3.2 0 1.6 1.6 0 0 1 3.2 0z',
      'm3.5 17.5 5-5 4.5 4.5 3-2.5 4.5 4',
    ],
  },
  ...
  tv: {
    stroke: 1.7,
    d: [
      'M4.5 7h15A2.5 2.5 0 0 1 22 9.5v9a2.5 2.5 0 0 1-2.5 2.5h-15A2.5 2.5 0 0 1 2 18.5v-9A2.5 2.5 0 0 1 4.5 7z',
      'm7 3 5 4 5-4',
    ],
  },
} as const
