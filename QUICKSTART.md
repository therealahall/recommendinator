...
**Available plugins:** Goodreads (books), Calibre-Web (books), Steam (games), GOG (games), Epic Games (games), Sonarr (TV shows), Radarr (movies), ROM Library (games), and generic CSV/JSON/Markdown importers for any content type.
