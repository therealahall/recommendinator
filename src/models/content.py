...
class ExternalId(BaseModel):
    source: str
    external_id: str
    # Filled by storage: the name a source was given lives in a table this
    # model cannot reach.
    display_name: str
...
class ContentItem(BaseModel):
    ...
    # Runtime-only: the names of the fields the operator holds against their
    # source. Empty for an item that has not come back from storage.
