...
- Takes the position from the `P1545` qualifier on a `P179` statement. A series
  stating no ordinal yields none — counting a `P155`/`P156` chain would invent
  the rank the qualifier exists to state.
